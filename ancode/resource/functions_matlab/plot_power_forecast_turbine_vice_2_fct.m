...
%            legend({,'Deterministic forecast','obs','50-60% percentile','40-50% percentile','60-70% percentile','30-40% percentile','70-80% percentile','20-30% percentile'})
            ...
            set(gca,'xtick',[1:6:nr_data_points],'xticklabels',date_labels([1:6:(23/Namelist{5}.Analog.lead_delta)],:),'fontsize',Namelist{7}.fontsize_sub_plot-3)
            ...
            if not(isdir(Namelist{1}.html_plots))
                ...
                save_file=[Namelist{1}.html_plots,'\power_forecast']
            else
                save_file=[Namelist{1}.html_plots,'\power_forecast']
            end 
            ...
            print(gcf, '-djpeg',save_file_department );
