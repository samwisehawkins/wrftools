function [ Namelist ] = set_Namelist_N30471( )
Namelist{1}.root_dir='/Users/jesper_nissen/Documents/MATLAB/work/AnEn'
Namelist{1}.forecast_horizon=36
% date formats
...
Namelist{1}.workspace_clean_obs_dir= '/Users/jesper_nissen/Documents/MATLAB/Data/power_obs/'
Namelist{1}.stat_plot_dir=[ Namelist{1}.root_dir,'/plots/stat_plots']
Namelist{1}.power_curve_file='C:/Users/jnini/MATLAB/work/Sand_box_model/Data/Powe_curves/V90_3_0_MW_VCS.txt'
Namelist{1}.ecmwf_eps_dir_in= [ Namelist{1}.root_dir,'/data/nwp/ECMWF/EPS/time_series']
Namelist{1}.experiment='Mahal_exp_Weighting_1'
...
Namelist{6}.Get_Power_Obs_even_when_not_all_is_producing=1

Namelist{7}.adjust_for_non_producing_turbines=1
Namelist{7}.minimum_turbines_producing_for_analogs=1
Namelist{7}.disregard_non_producing_turbines=0
