function [ new_forecast ] = make_forecast(lates_init_time,last_updated,Namelist,first_time)
...
%attemp to get the newest nwp data
 ...
 [new_timeseries_data new_2d_data]=down_load_data(Namelist);
    if new_timeseries_data % can be due to old data has arrived etc 
                % case 1:0-12 H differnece between last updated and arrival time of new files 
                % case 2:12-24 4H 
                % 
         switch 1 
