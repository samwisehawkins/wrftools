function [ hit_rate false_alarm_rate  ] = do_roc_diagram_WRF_d1( Namelist,analogs )
%DO_ROC_DIAGRAM Summary of this function goes here
%   Detailed explanation goes here

close all
    exp_name='Turbine_by_turbine_winter_1_mslp_wspd_wdir_rho_shear_domaine_1'
    ...
    Namelist{4}.nwp_model_domain=1;Namelist{4}.nwp_model{1}='WRF'
    ...
    for j=analogs_lead_times
        ...
        % normalize all power data 
             ...
             first_time=1
             counter=0
             event_tresshold=0.50 % turbine producing less than 20%
             treshold_counter=0
        ...
        for fixed_tresshold=fixed_tresshold_values
           ...
           false_alarm_rate=cat(2,ones(j,1),false_alarm_rate)
            ...
            plot_filename=['\wrf_d1_roc_diagram_',nr_analogs,'_analogs_wrf_shear_turbine-lead-',num2str(j),'H']
                    if isdir(save_dir)
