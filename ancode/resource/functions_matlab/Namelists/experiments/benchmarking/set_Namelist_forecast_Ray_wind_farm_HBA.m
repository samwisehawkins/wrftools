function [ Namelist ] = set_Namelist_forecast_Ray_wind_farm_CBA( )
...
Namelist{1}.experiment='/benchmarking/Ray_wind_farm_RA_HBA'
...
%Ray wind farm 
Namelist{5}.Analog.weights_state_vector_idx=[1  0  0  1  0  0  0  0  0  1 0 0]
...
Namelist{5}.start_forecast_period= '2006010100'
Namelist{5}.Analog.now=Namelist{5}.start_forecast_period
Namelist{5}.end_forecast_period= '2011010800'
%Namelist{5}.start_analog_search_period= '2010-10-31 12:00' % should be the same as obs start 
Namelist{5}.start_analog_search_period= '2007010100' % should be the same as obs start 
Namelist{5}.currant_analog_period=Namelist{5}.start_analog_search_period 
Namelist{5}.end_analog_search_period= '2008123100'
