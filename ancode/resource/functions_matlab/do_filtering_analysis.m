...
plot(model_ANALOG_10_light_filtered_and_banned,':g')
 ...
 subplot(3,1,1)
     ...
     ylim([0 .4]);ylabel('Normalized RMSE','fontsize',Namelist{7}.fontsize);title('ETA based powerforecast for Sprogø offshore wind farm Sep-Dec 2010','fontsize',Namelist{7}.fontsize+2 )
     colormap('gray')
   subplot(3,1,2)  
