function [ good_turbine_data time_serie_nwp_forecast num_obs_dates clean_turbine_data] = load_data_forecasting( Namelist )
    ...
    switch 1
        ...
        case strcmp(Namelist{4}.nwp_model{1},'WRF')
            ...
            if Namelist{1}.use_all_forecast_files
                tempo_1=get_time_series_WRFforecast(Namelist);
                ...
                Namelist{1}.forecast_data_dir=strcat('C:\Users\jnini\MATLAB\work\AnEn\data\nwp\wrf\Historical_files_',Namelist{4}.WRF_sst_fields)
                tempo_2=get_time_series_WRFforecast(Namelist);
                for i=1:length(tempo_2)
                    time_serie_nwp_forecast{1,i}=vertcat(tempo_1{1,i}, tempo_2{1,i});
                ...
                time_serie_nwp_forecast=get_time_series_WRFforecast(Namelist);
                time_serie_nwp_forecast=get_std_on_nwp_variables(time_serie_nwp_forecast);
                time_serie_nwp_forecast=get_diagnostics_on_nwp_variables(time_serie_nwp_forecast,Namelist);
