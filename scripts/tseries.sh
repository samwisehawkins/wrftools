...
NCL_IN_FILE=${ncl_in_file} NCL_OUT_FILE=${ncl_out_file} NCL_LOC_FILE=config/locations.csv NCL_OUT_TYPE=nc NCL_OPT_FILE=config/options.ncl ncl ncl/extract_time_series.ncl
