"""interp_time_series.py is a basic interpolation and extraction script which interpolations to locations and heights.

Usage: 
    interp_time_series.py <file>... --loc=<file> --height=<h>... [--out=<dir>] --domain=<dom> --model-run=<run>  [-h | --help] [--ncl-code=<path>] [--loop | --aggregate]
